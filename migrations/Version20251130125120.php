 ...
 */
final class Version20251130125120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe_ingredient ADD COLUMN unit VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe_ingredient AS SELECT id, quantity, recipe_id, ingredient_id FROM recipe_ingredient');
        ...
        $this->addSql('INSERT INTO recipe_ingredient (id, quantity, recipe_id, ingredient_id) SELECT id, quantity, recipe_id, ingredient_id FROM __temp__recipe_ingredient');
